        ...
        # contains sub-dicts, key='input/animal/animal_date', value=dict of stats
            ...
            if not ((tmp_correct_licks+tmp_bad_ignores == tmp_nTargets) \
                ...
                if (tmp_correct_licks+tmp_bad_ignores) != tmp_nTargets:
                    ...
                    print 'TARGS:  ', tmp_nTargets
                    print 'CORR-LICKS + BAD-IGNS: ', tmp_correct_licks, tmp_bad_ignores, targ_outcomes
                if (tmp_correct_ignores+tmp_bad_licks) != tmp_nDistractors:
                    ...
                    print 'DISTS:  ', tmp_nDistractors
                    print 'CORR-IGNS + BAD-LICKS: ', tmp_correct_ignores, tmp_bad_licks, dist_outcomes
            # else:
